// Pure, framework-free stock screening math shared between the frontend
// (src/lib/stockApi.ts re-exports these) and the backend (server/, including
// the Telegram agent's screen_watchlist tool). No network calls, no browser
// or Node-specific APIs — keep it that way so it stays importable from both.
